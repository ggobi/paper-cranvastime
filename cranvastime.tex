...
\red{windows \citet{XXX}} to explore data. \citet{xie2014reactive} describes
...
\begin{centering}
\begin{tabular}{cc}
\includegraphics[width=0.48\textwidth]{graph/pipeline-27-1} & \multirow{3}{*}[1.8in]{\includegraphics[width=0.45\textwidth]{graph/pipeline-27-3}} \tabularnewline
\includegraphics[width=0.48\textwidth]{graph/pipeline-27-2} & \tabularnewline
\includegraphics[width=0.48\textwidth]{graph/pipeline-27-4} & \tabularnewline
\end{tabular}
\end{centering}
\caption{\label{fig:linking}Three additional figures here
illustrating linking. Multiple series where one time point
is brushed. One where the brush picks one point in a series
and the whole series highlights. The other where you have
a different plot linked to the time series, would suggest
map of the USA and google flu trends.}
\end{figure}
\par\end{center}
