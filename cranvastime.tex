...
Longitudinal data and time series data, although analyzed very differently, have in common a context of time.  There are several different ways that time is commonly displayed in plots.
...
for the univariate time series. For the longitudinal data, the
line graph is commonly used, like Figure \ref{fig:Line-graph}, but called a profile plot.
...
\caption{\label{fig:Line-graph}Profile plot for the longitudinal data.}
\end{figure}
