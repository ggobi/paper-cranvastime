...
Wrapping/slicing cut the series by a fixed-length interval in
...
\left(-\left(\mathbf{l}{}_{ij} -1\right)\times\left(x_{(n-\sum_{a=1}^j u_{ia})}-x_{(1)}\right), \; 0\right) & \sum_{a=1}^j u_{ia}\ge n-2.
\end{cases}
\end{eqnarray*}
