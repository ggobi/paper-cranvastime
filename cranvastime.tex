...
\begin{eqnarray*}
x_{new} & = & \begin{cases}
(x-x_{(1)})\mod(x_{(n-j)}-x_{(1)})+x_{(1)} & \mbox{if~} 0\equiv (x-x_{(1)})\mod(x_{(n-j)}-x_{(1)})\\
x_{(n-j)} &  \mbox{if~} 0\neq (x-x_{(1)})\mod(x_{(n-j)}-x_{(1)})
\end{cases} \\ & = & \begin{cases}
(x-x_{(1)})-\left\lfloor\frac{x-x_{(1)}}{x_{(n-j)}-x_{(1)}}\right\rfloor\times(x_{(n-j)}-x_{(1)})+x_{(1)} & 0\equiv (x-x_{(1)})\mod(x_{(n-j)}-x_{(1)})\\
x_{(n-j)} & 0\neq (x-x_{(1)})\mod(x_{(n-j)}-x_{(1)})
\end{cases} \\ & = &
(x-x_{(1)})-\left(\left\lceil\frac{x-x_{(1)}}{x_{(n-j)}-x_{(1)}}\right\rceil -1\right)\times(x_{(n-j)}-x_{(1)})+x_{(1)} \\ & = &
x-\left(\left\lceil \frac{x-x_{(1)}}{x_{(n-j)}-x_{(1)}}\right\rceil -1\right)\times(x_{(n-j)}-x_{(1)}),
\end{eqnarray*}
which shows the movements are
\begin{eqnarray*}
\mathbf{m}{}_{ij} & = & \begin{cases}
(-\left(\left\lceil \frac{\mathbf{x}-x_{(1)}}{x_{(n-j)}-x_{(1)}}\right\rceil -1\right)\times(x_{(n-j)}-x_{(1)}), \; 0) & 1\leq j \leq n-3 \\
(-\left(\left\lceil \frac{\mathbf{x}-x_{(1)}}{x_{(3)}-x_{(1)}}\right\rceil -1\right)\times(x_{(3)}-x_{(1)}), \; 0) & j\ge n-2
\end{cases} \\ & \equiv & \begin{cases}
(-(\mathbf{l}{}_{ij} -1)\times(x_{(n-j)}-x_{(1)}), \; 0) & 1\leq j \leq n-3 \\
(-(\mathbf{l}{}_{ij} -1)\times(x_{(3)}-x_{(1)}), \; 0) & j\ge n-2.
\end{cases}
\end{eqnarray*}
...
we have
\begin{eqnarray*}
x_{new} & = & x-\left(\left\lceil \frac{x-x_{(1)}}{x_{(n-\sum_{a=1}^j u_{ia})}-x_{(1)}}\right\rceil -1\right)\times(x_{(n-\sum_{a=1}^j u_{ia})}-x_{(1)}), \\
\mathbf{m}{}_{ij} & = & \begin{cases}
(-(\mathbf{l}{}_{ij} -1)\times(x_{(n-\sum_{a=1}^j u_{ia})}-x_{(1)}), \; 0) & 1\leq \sum_{a=1}^j u_{ia} \leq n-3 \\
(-(\mathbf{l}{}_{ij} -1)\times(x_{(3)}-x_{(1)}), \; 0) & \sum_{a=1}^j u_{ia}\ge n-2.
\end{cases}
\end{eqnarray*}
...
\begin{eqnarray*}
x_{new} & = & x-\left(\left\lceil \frac{x-x_{(1)}}{x_{(p_{i1})}-x_{(1)}}\right\rceil -1\right)\times(x_{(p_{i1})}-x_{(1)}), \\
\mathbf{m}{}_{ij} & = &
(-(\mathbf{l}{}_{ij} -1)\times(x_{(p_{i1})}-x_{(1)}), \; 0).
\end{eqnarray*}
