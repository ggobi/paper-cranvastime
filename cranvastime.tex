...
\begin{figure}[h]
\begin{centering}
\includegraphics[width=0.48\textwidth]{graph/pipeline-01-1} \includegraphics[width=0.48\textwidth]{graph/pipeline-02-1}
\par\end{centering}
...
done on-the-fly. Figure \ref{fig:faceting-2ind} shows faceting on
individual by two independent groups (longitude and latitude). Both
horizontal and vertical directions can be utilized to facet. 
Figure \ref{fig:faceting-period} explains why and shows how to
facet on period. Those faceting methods change the y-coordinates
...
\begin{figure}[H]
\begin{centering}
\includegraphics[width=0.4\textwidth]{graph/pipeline-24-1} \includegraphics[width=0.4\textwidth]{graph/pipeline-24-3}
\par\end{centering}

\begin{centering}
\includegraphics[width=0.4\textwidth]{graph/pipeline-24-2} \includegraphics[width=0.4\textwidth]{graph/pipeline-24-4}
\par\end{centering}
...
by longitudinal grid. (Bottom left) Faceting by latitudinal grid.
...
\begin{centering}
\includegraphics[width=0.48\textwidth]{graph/pipeline-16-1} \includegraphics[width=0.48\textwidth]{graph/pipeline-16-2}
\par\end{centering}

\begin{centering}
\includegraphics[width=0.48\textwidth]{graph/pipeline-16-xwrap} \includegraphics[width=0.48\textwidth]{graph/pipeline-16-xwrap-facet}
\par\end{centering}
