...
are separated.  (e) disperses the variables for each individual in
 (c). Video footage illustrating these steps is available at \url{https://vimeo.com/112438919}.}
\end{figure}
...
\ref{sub:Additivity}. \red{Yes, but you need to show some equations if possible.}
