...
\caption{\label{fig:Time-series-plots}Time series plots for regular time spacing
 (left) and irregular time spacing  (right). \red{*** trim off the long tail on the longitudinal data plot.}}
\end{figure}
...
\caption{\label{fig:Line-graph}Line graph for the longitudinal data. \red{*** trim off the long tail on the longitudinal data plot.}}
\end{figure}
