...
can change the size and transparence of dots. The new size (or
transparence) is always calculated by the multiplication of the
current size (or transparence) and a constant. The constant is
greater than 1 if the parameter is increasing, and less than 1 if
the parameter is decreasing. Another example is the record of brush
history, i.e., the history of selected data, in \texttt{\textbf{cranvas}}.
