...
Wrapping/slicing cuts the series by a fixed-length interval in
the horizontal/vertical direction, and shifts the right/top pieces
...
Slicing, also indicated by y-wrapping, could use similar
formulas to get the movements in the y-direction.
