...
can record the brush history, i.e., the history of selected data.
If the user wants to undo or redo the brushing, the historical index
will be obtained from the current index and the keystroke,
then the brush is replaced by the history.
