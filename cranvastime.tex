...
$\# points=\#edges+n.$
In the area layer, each polygon is defined by a number of edges, \red{i.e., 
$\#polygons=\#edges.$ I don't think this is right}
The color of lines follows from the color of the first point of the line segment. For polygons, \red{the color is mapped ***}
