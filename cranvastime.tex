...
position is calculated by the starting position and the projection
...
$\mathcal{I}$. In \texttt{\textbf{XGobi}} and \texttt{\textbf{GGobi}},
data projection is the only reason for data coordinate modification.
...
are mixed, the baseline method makes the computation structured.
