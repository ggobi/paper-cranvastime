...
{\tiny{}}%
\begin{tabular}{ccc}
{point layer} & {line layer} & {area layer}\tabularnewline
{\tiny{}}%
\begin{tabular}{|c|c|c|}
\hline 
{\tiny{x}} & {\tiny{y}} & {\tiny{color}}\tabularnewline
\hline 
{\tiny{1}} & {\tiny{3}} & {\tiny{peach}}\tabularnewline
{\tiny{2}} & {\tiny{5}} & {\tiny{olive}}\tabularnewline
{\tiny{3}} & {\tiny{2}} & {\tiny{cyan}}\tabularnewline
{\tiny{4}} & {\tiny{4}} & {\tiny{purple}}\tabularnewline
{\tiny{5}} & {\tiny{3}} & {\tiny{peach}}\tabularnewline
\hline 
\end{tabular} & {\tiny{}}%
\begin{tabular}{|cc|cc|c|}
\hline 
{\tiny{x-start}} & {\tiny{x-end}} & {\tiny{y-start}} & {\tiny{y-end}} & {\tiny{color}}\tabularnewline
\hline 
{\tiny{1}} & {\tiny{2}} & {\tiny{3}} & {\tiny{5}} & {\tiny{peach}}\tabularnewline
{\tiny{2}} & {\tiny{3}} & {\tiny{5}} & {\tiny{2}} & {\tiny{olive}}\tabularnewline
{\tiny{3}} & {\tiny{4}} & {\tiny{2}} & {\tiny{4}} & {\tiny{cyan}}\tabularnewline
{\tiny{4}} & {\tiny{5}} & {\tiny{4}} & {\tiny{3}} & {\tiny{purple}}\tabularnewline
\hline 
\multicolumn{1}{c}{} & \multicolumn{1}{c}{} &  & \multicolumn{1}{c}{} & \multicolumn{1}{c}{}\tabularnewline
\end{tabular} & {\tiny{}}%
\begin{tabular}{|cccc|cccc|c|}
\hline 
{\tiny{x1}} & {\tiny{x2}} & {\tiny{x3}} & {\tiny{x4}} & {\tiny{y1}} & {\tiny{y2}} & {\tiny{y3}} & {\tiny{y4}} & {\tiny{color}}\tabularnewline
\hline 
{\tiny{1}} & {\tiny{2}} & {\tiny{2}} & {\tiny{1}} & {\tiny{3}} & {\tiny{5}} & {\tiny{1}} & {\tiny{1}} & {\tiny{peach}}\tabularnewline
{\tiny{2}} & {\tiny{3}} & {\tiny{3}} & {\tiny{2}} & {\tiny{5}} & {\tiny{2}} & {\tiny{1}} & {\tiny{1}} & {\tiny{olive}}\tabularnewline
{\tiny{3}} & {\tiny{4}} & {\tiny{4}} & {\tiny{3}} & {\tiny{2}} & {\tiny{4}} & {\tiny{1}} & {\tiny{1}} & {\tiny{cyan}}\tabularnewline
{\tiny{4}} & {\tiny{5}} & {\tiny{5}} & {\tiny{4}} & {\tiny{4}} & {\tiny{3}} & {\tiny{1}} & {\tiny{1}} & {\tiny{purple}}\tabularnewline
\hline 
\multicolumn{1}{c}{} &  &  & \multicolumn{1}{c}{} &  &  &  & \multicolumn{1}{c}{} & \multicolumn{1}{c}{}\tabularnewline
...
\caption{\label{tab:coordinates-for-layers}Data to generate
three layers for Figure \ref{fig:features}. The data for
point layer is in the same structure as the original
time series. In the line layer, coordinates for both
sides of four edges are generated from the point data.
More information is needed for the area layer -- 1 is
chosen as the baseline. The x/y coordinates for four
vertexes in each polygon are given, in which the first two
columns for both x and y are adopted from the line layer.}
\end{table}
