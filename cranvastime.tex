...
\caption{\label{fig:Time-series-plots}Time series plots for regular time spacing
 (left) and irregular time spacing  (right). \red{Can you add tick mark lines on the horizontal axis that show the times of measurements? That will make the regular and irregular collection clearer.} }
\end{figure}
